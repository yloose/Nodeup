...
#include <jni.h>
/* Header for class de_yloose_nodeup_backend_NetworkService */

#ifndef _Included_de_yloose_nodeup_backend_NetworkService
#define _Included_de_yloose_nodeup_backend_NetworkService
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     de_yloose_nodeup_backend_NetworkService
